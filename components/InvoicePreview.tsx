...
const InvoicePreview: React.FC<InvoicePreviewProps> = ({ data }) => {
  ...
  return (
    <div className="invoice-preview-container bg-white shadow-xl rounded-sm w-full max-w-[210mm] min-h-[297mm] mx-auto p-12 text-gray-800 relative flex flex-col">
